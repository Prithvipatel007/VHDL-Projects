...
vcom -work work -explicit -2008 ../tb/mc_reception/tb_morse_encoder_e.vhd
vcom -work work -explicit -2008 ../tb/mc_reception/tb_morse_encoder_a.vhd
...
vsim -voptargs=+acc -t 1ns work.tb_morse_encoder_e
