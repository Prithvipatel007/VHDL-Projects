...
vcom -work work -explicit -2008 ../tb/mc_reception/tb_uart_receiver_e.vhd
vcom -work work -explicit -2008 ../tb/mc_reception/tb_uart_receiver_a.vhd
...
vsim -voptargs=+acc -t 1ns work.tb_uart_receiver_e
