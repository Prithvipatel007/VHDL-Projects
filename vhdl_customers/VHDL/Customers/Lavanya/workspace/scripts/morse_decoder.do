...
vcom -work work -explicit -2008 ../tb/mc_transmission/tb_morse_decoder_e.vhd
vcom -work work -explicit -2008 ../tb/mc_transmission/tb_morse_decoder_a.vhd
...
vsim -voptargs=+acc -t 1ns work.tb_morse_decoder_e
