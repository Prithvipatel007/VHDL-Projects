...
vcom -work work -explicit -2008 ../tb/tx/tb_morse_ascii_e.vhd
vcom -work work -explicit -2008 ../tb/tx/tb_morse_ascii_a.vhd
...
vsim -voptargs=+acc -t 1ns work.tb_morse_ascii_e
