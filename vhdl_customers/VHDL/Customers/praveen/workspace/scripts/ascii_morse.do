...
vcom -work work -explicit -2008 ../tb/rx/tb_ascii_morse_e.vhd
vcom -work work -explicit -2008 ../tb/rx/tb_ascii_morse_a.vhd
...
vsim -voptargs=+acc -t 1ns work.tb_ascii_morse_e
